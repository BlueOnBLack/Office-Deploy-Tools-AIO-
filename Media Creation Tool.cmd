...
if not defined xTmp (
	if not exist BuildInfo.ini (
		...
		echo.
		echo Supprted C2R Versions 	:: [ 2013, 2016, 2019, 2021, 2024 ] [ Fallback -- 2021 ]
...
if %errorlevel% NEQ 0 (
    ...
    if /i '%productyear%' NEQ '2024' (echo %*|>nul find /i ".cat" && goto :eof)
...
1>nul 2>&1 del /q "%windir%\Temp\v!xBit!.cab"
1>nul 2>&1 del /q "%windir%\Temp\VersionDescriptor.xml"
goto :eof
